    ...
    const columns = [
        ...
        ...roles.map(role => ({
            ...
            render: (_: any, record: Permission) => {
                ...
                // Admin should usually have everything, but let's allow toggling even for Admin for flexibility
                // Disable admin check if key is 'manage_roles' to prevent locking oneself out
    ...
    return (
        <div style={{ 
            ...
            <div style={{ 
                flex: 1,
                overflowY: 'auto',
                paddingRight: 8 // Avoid scrollbar covering content
            }}>
                <Collapse 
